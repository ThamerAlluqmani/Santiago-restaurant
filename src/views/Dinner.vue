<template>
  <div class="container mt-5">
    ...
    <div class="row mt-5 mb-5">
      ...
      <Card :url="{name:'HealthyBreakfast'}"  img="1/dessert-2.png" title="الحلويات الجديدة"></Card>
      <Card :url="{name:'HealthyBreakfast'}"  img="1/breakfast-7.png" title="الوجبات الرئيسية"></Card>
    </div>
